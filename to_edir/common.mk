...
OPTEE_GET_TIME_PATH		?= $(ROOT)/optee_get_time
...
BR2_PACKAGE_GET_TIME_EXT ?= y
BR2_PACKAGE_GET_TIME_EXT_CROSS_COMPILE ?= $(CROSS_COMPILE_S_USER)
BR2_PACKAGE_GET_TIME_EXT_SDK ?= $(OPTEE_OS_TA_DEV_KIT_DIR)
BR2_PACKAGE_GET_TIME_EXT_SITE ?= $(GET_TIME_PATH)
